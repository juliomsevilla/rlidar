...
-   Teledetección activa: emiten energía que les permite "escanear" objetos y áreas. El sistema mide la radiación reflejada del objetivo.
    ...
    ![](%5B%5Bhttps://raw.githubusercontent.com/juliomsevilla/rlidar/main/images/activa.png)](<https://raw.githubusercontent.com/juliomsevilla/rlidar/main/images/pasiva.png>))](<https://raw.githubusercontent.com/juliomsevilla/rlidar/main/images/markdown.png>))
...
A continuación crearemos uan estructura de carpetas, predefinida, de forma que el trabajo sea lo más sitemático posible. Con ellas creadas, fijamos el directorio de trabajo y procedemos a descargar y descomprimir los datos LiDAR, vectoriales, raster y tabulares de los que disponemos del trabajo de campo y del vuelo LiDAR:
